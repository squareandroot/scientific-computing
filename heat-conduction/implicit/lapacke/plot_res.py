...
path = "/home/andreas/scientific-computing/heat-conduction/implicit/lapacke/out/"
...
for no in fileNo:
    files.append(np.loadtxt(path + "out-lapacke-t{}.dat".format(no)))
...
for i in range(1, time_steps+1):
    files2.append(np.loadtxt(path + "out-lapacke-t{}.dat".format(i)))
